# Compatibility shard 1 for public_surfaces.
...
_PUBLIC_SURFACE_NAMES = (
    ...
    "harness_feedback_repeated_case_view",
...
_PUBLIC_SURFACE_PURPOSES = {
    ...
    "harness_feedback_bundle": "legacy read-only compatibility validator for historical Harness Feedback bundles; no production builder or downstream action is exposed",
    "harness_feedback_case_write": "review-only canonical problem-dossier write receipt with no engineering, Skill, or research-trust authority",
    "harness_feedback_problem_dossier": "legacy read-only compatibility validator for historical problem dossiers; new feedback uses the typed harness_feedback_cases family",
    "harness_feedback_repeated_case_view": "read-only aggregation of recurring Harness Feedback cases by source fingerprint, impact, recency, and review status",
    ...
    "run_dir_provenance_extractor_plan": "legacy read-only compatibility validator for historical run-directory extractor plans",
