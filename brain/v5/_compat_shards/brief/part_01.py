# Compatibility shard 1 for brief.
...
from brain.v5.references import list_legacy_reference_locations_for_brief, reference_location_brief_payload
...
def build_execution_brief(ws, session_id: str) -> dict[str, Any]:
    ...
    if session.active_claim:
        ...
        raw_reference_locations = list_legacy_reference_locations_for_brief(
            ws, claim.claim_id
        )
        reference_locations = [
