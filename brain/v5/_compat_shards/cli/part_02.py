...
def _add_parser_section_02(sp):
    ...
    ep = sp.add_parser("evidence")
    es = ep.add_subparsers(dest="evidence_command", required=True)
    evr = es.add_parser("record")
    evr.add_argument("--topic", required=True, dest="topic_id")
    evr.add_argument("--claim", required=True, dest="claim_id")
    evr.add_argument("--type", required=True, dest="evidence_type")
    evr.add_argument("--status", required=True)
