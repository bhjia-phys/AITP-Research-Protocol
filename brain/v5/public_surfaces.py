...
_PUBLIC_SURFACE_PURPOSES = {
    ...
    "context_profile_draft": "read-only Context Compiler v2 materialized group-meeting or closeout draft filled from typed-record context packs and profile templates without creating records, evidence, validation, final gates, or claim-trust authority",
    ...
    "domain_pack_catalog": "read-only catalog and claim-text suggestion surface for domain experience packs, external skill refs, workflow routes, failure modes, and lane policies without evidence, validation, skill materialization, or claim-trust authority",
    "domain_skill_shim_manifest": "preview or explicit project-file write manifest for external domain skill SKILL.md shims generated from domain-pack skill refs; shims are orientation-only and cannot create evidence, validation, external skill content copies, memory, or claim trust",
    ...
    "literature_corpus_extraction_artifact": "read-only corpus-backed extraction artifact draft that aligns curated RAG chunks to typed exact reference locations without creating artifact, evidence, validation, final-gate, or trust authority",
    ...
    "knowledge_connector_binding_registry": "workspace-local connector binding registry for QFT/QG/LibRPA corpora and notes; it is configuration metadata only and cannot create evidence, validation, source support, memory, or claim trust",
    ...
    "quiet_checkpoint_batch": "contracted batch checkpoint for research bursts that writes selected typed records and returns a completeness audit without evidence, validation, L2, or claim-trust authority",
    "quiet_checkpoint_preview": "read-only preview of a research-burst checkpoint batch, planned typed writes, and completeness audit without mutating kernel state",
