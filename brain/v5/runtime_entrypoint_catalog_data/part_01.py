...
RUNTIME_ENTRYPOINTS_01 = {
    ...
    'codex_hook_installation': {"cli": "aitp-v5 adapter install-hooks codex --routing-mode <mode> <args>", "mcp": "aitp_v5_install_codex_hook_fixture", "surface": "codex_hook_installation"},
    ...
    'opencode_hook_installation': {"cli": "aitp-v5 adapter install-hooks opencode --routing-mode <mode> <args>", "mcp": "aitp_v5_install_opencode_hook_fixture", "surface": "opencode_hook_installation"},
    ...
    'claude_code_hook_installation': {"cli": "aitp-v5 adapter install-hooks claude-code --routing-mode <mode> <args>", "mcp": "aitp_v5_install_claude_code_hook_settings", "surface": "claude_code_hook_installation"},
    ...
    'kimi_code_hook_installation': {"cli": "aitp-v5 adapter install-hooks kimi-code --routing-mode <mode> <args>", "mcp": "aitp_v5_install_kimi_code_hook_config", "surface": "kimi_code_hook_installation"},
