...
def validate_workspace_file_migration_ledger(
    ...
    *,
    ...
    if not isinstance(summary, dict):
        ...
        summary = {}
    for key in ("file_decision_count", "expected_total_file_count", "blocking_file_count"):
...
def validate_workspace_file_migration_ledger_progress(
    ...
    *,
    ...
    for key in ("no_omission_check", "old_store_retirement_safe", "semantic_review_required"):
