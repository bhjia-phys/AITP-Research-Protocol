...
def test_allow_decision_and_successful_receipt_resolve_by_exact_pins(tmp_path):
    ...
    resolved = resolve_source_acquisition_for_source_asset(
        ws,
        receipt.pinned_ref,
    ...
    assert "decision_ref.record_ref" in record_family_specs()["source_acquisition_receipts"].dependency_fields
