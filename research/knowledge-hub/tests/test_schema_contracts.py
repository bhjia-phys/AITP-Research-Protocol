...
class SchemaContractTests(unittest.TestCase):
    ...
    def test_topic_synopsis_schema_exposes_runtime_focus_and_truth_sources(self) -> None:
        ...
        self.assertIn("contradiction_candidates", intake)
        self.assertIn("notation_tension_candidates", intake)
        self.assertIn("evidence_sentence_ids", intake["assumption_rows"]["items"]["properties"])
        self.assertIn("evidence_sentence_ids", intake["regime_rows"]["items"]["properties"])
        self.assertIn("evidence_sentence_ids", intake["method_specificity_rows"]["items"]["properties"])
        self.assertIn("evidence_sentence_ids", intake["notation_rows"]["items"]["properties"])
        self.assertIn("notation_rows", intake)
        self.assertIn("contradiction_candidates", intake)
        self.assertIn("notation_tension_candidates", intake)
    ...
    def test_progressive_disclosure_runtime_schema_exposes_stable_trigger_contract(self) -> None:
        ...
        self.assertIn("evidence_sentence_ids", payload["$defs"]["l1_assumption_row"]["properties"])
        self.assertIn("evidence_sentence_ids", payload["$defs"]["l1_regime_row"]["properties"])
        self.assertIn("evidence_sentence_ids", payload["$defs"]["l1_method_specificity_row"]["properties"])
        self.assertIn("evidence_sentence_ids", payload["$defs"]["l1_notation_row"]["properties"])
        ...
        self.assertIn("source_evidence_sentence_ids", contradiction_candidate)
        ...
        self.assertIn("against_evidence_sentence_ids", contradiction_candidate)
