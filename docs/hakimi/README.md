...
- Historical runtime audit: **2026-08-08**, AITP HEAD
  ...
  the 2026-08-15 0.6.0 Skill-only amendment, and the 2026-08-15 M1e runtime slice below.
...
| H1 | M1a done; deterministic gate passed | Read-only feature detection and schema dispatch for `aitp/enter-0.2`, `aitp/list-0.1`, and `aitp/show-0.1`; closeout-first handoff; Note-age signal; generated-golden compatibility tests; plugin version `0.2.0` (H1-era; current plugin version `0.7.0`, 2026-08-15 M1e) |
...
here. M1a has landed; the synchronized version metadata is `0.7.0`
(2026-08-15 M1e runtime slice; 0.6.0 was the preceding Skill-only release — no
