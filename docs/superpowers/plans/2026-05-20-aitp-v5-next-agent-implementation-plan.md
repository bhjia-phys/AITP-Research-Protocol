...
```text
661206a feat(v5): migrate legacy l1 audit records, or a later completed commit from this plan
```
...
- Legacy migration still needs broader old-topic coverage for old L1 intake and richer source anchors.
