...
real_research_checked:
  - <private-research-source>/quantum-chaos (no .aitp; real research dirs)
  - <private-research-source>/materials-workflow (patches, runbooks, analysis, scripts)
  - <private-legacy-topics-root>/.aitp (legacy v5 store, ~50 topics, 63+ registry types)
