...
source_checkpoint: 869d8e65f19e69404405e4da976876be8fc7f9a0 (AITP-2-evidence, read-only)
path_normalization_note: >
  Machine-specific absolute research paths in the original audit have been replaced
  with stable symbolic placeholders. Only machine-local absolute research paths were
  normalized; no scientific or audit conclusions were altered.
scope:
